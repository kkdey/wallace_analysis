---
title: 'Wallacea region GoM analysis : mammals - no bats and birds'
author: "Kushal K Dey"
date: "6/8/2018"
...
latlong_chars_mammals <- rownames(mamms)
```
...
```{r}
pooled_latlong <- intersect(latlong_chars_mammals, latlong_chars_birds)
mamms_pool <- mamms[match(pooled_latlong, latlong_chars_mammals), ]
birds_pool <- birds[match(pooled_latlong, latlong_chars_birds), ]
```

```{r}
latlong <- cbind.data.frame(as.numeric(sapply(pooled_latlong, 
...
```{r}
combined_data <- cbind(mamms_pool, birds_pool)
```
...
```{r}
richness <- rowSums(combined_data)
```
...
save(topics_clust, file = "../output/methClust_wallacea_mammals_and_birds_no_bats.rda")
...
```{r}
topics_clust <- get(load("../output/methClust_wallacea_mammals_and_birds_no_bats.rda"))
```
...
![](Wallacea_mammals_birds/geostructure_2.png)


### K = 3

![](Wallacea_mammals_birds/geostructure_3.png)

### K = 4

![](Wallacea_mammals_birds/geostructure_4.png)

### K = 5

![](Wallacea_mammals_birds/geostructure_5.png)

### K = 6

![](Wallacea_mammals_birds/geostructure_6.png)


### K = 7

![](Wallacea_mammals_birds/geostructure_7.png)

### K = 8

![](Wallacea_mammals_birds/geostructure_8.png)


### K = 9

![](Wallacea_mammals_birds/geostructure_9.png)

### K = 10

![](Wallacea_mammals_birds/geostructure_10.png)
