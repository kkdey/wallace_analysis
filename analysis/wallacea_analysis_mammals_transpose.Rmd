---
title: 'Wallacea region GoM : mammals transpose'
author: "Kushal K Dey"
date: "6/6/2018"
...
```{r}
birds <- get(load("../data/mammals_with_bats.rda"))
...
```{r}
topics_clust <- get(load("../output/methClust_wallacea_mammals_bats_transpose.rda"))
```
