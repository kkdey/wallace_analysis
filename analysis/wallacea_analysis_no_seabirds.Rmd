...
intensity <- 0.8
for(k in 2:10){
  png(filename=paste0("../output/Wallacea/geostructure_birds_", k, ".png"),width = 1000, height = 800)
map("worldHires",
...
![geostructure2](../output/Wallacea/geostructure_birds_2.png)

![geostructure3](../output/Wallacea/geostructure_birds_3.png)

![geostructure4](../output/Wallacea/geostructure_birds_4.png)

![geostructure5](../output/Wallacea/geostructure_birds_5.png)

![geostructure6](../output/Wallacea/geostructure_birds_6.png)

![geostructure7](../output/Wallacea/geostructure_birds_7.png)
![geostructure8](../output/Wallacea/geostructure_birds_8.png)
![geostructure9](../output/Wallacea/geostructure_birds_9.png)

![geostructure10](../output/Wallacea/geostructure_birds_10.png)
