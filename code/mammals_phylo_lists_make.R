...
#################  Phylogenetic lists for mammals (with bats) #########################

model <- get(load("../output/methClust_wallacea_mammals_bats.rda"))
library(CountClust)
...
save(list_species, file = "../output/mammals_lists_for_phylogeny_clusters_2_wallacea.rda")
